...
{
    //we created this class for to feed the data in our tables for sample because we don't want our catalog should be empty
    public static class CatalogSeed
    {
        //creating seed method to create the tables from catalog context
        ...
        private static IEnumerable<CatalogBrand> GetPreConfiguredCatalogBrand()
        {
            //create a new list and add the brands we want

            /* List<CatalogBrand> catalogbrand = new List<CatalogBrand>();
             CatalogBrand brands = new CatalogBrand();
             brands.Brand = "Tiffany & Co";
             brands.Brand = "DeBeers";
             brands.Brand = "Graff";
        ...
        //Creating method for getpreconfiguredcatalogtype to add types in our 
        //table changing to ienumerable because of collection
